...
export function ProductDetailClient({ product }: { product: Product }) {
  ...
  return (
    <div className="pb-24 md:pb-12">
      <div className="md:grid md:grid-cols-2 md:gap-12 md:max-w-5xl md:mx-auto md:px-10 md:pt-10">
        {/* Image — pleine largeur mobile, contenue et arrondie desktop */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.4 }}
          className="aspect-square bg-surface flex items-center justify-center md:rounded-3xl md:sticky md:top-24 overflow-hidden"
        >
          {product.image_url ? (
            <img
        ...
        <motion.div
          ...
          className="px-6 md:px-0 py-6 md:py-0 max-w-2xl mx-auto md:mx-0"
        >
